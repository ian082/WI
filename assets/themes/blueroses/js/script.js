(function ($) {
  ...
  var $allContentDivs = $('#sampul-konten, #mempelai-konten, #acara-konten, #album-konten, #ucapan-konten, #lokasi-konten, #hadiah-konten, #prokes-konten').hide(); // Hide All Content Divs

  $('#sampul-konten').show();
  $('.dekorasi-sampul').show();
  $('.dekorasi-all').hide();

  $('#sampul, #mempelai, #acara, #album, #ucapan, #lokasi, #hadiah, #prokes').click(function () {
  ...
  audio_button.addEventListener('click', function () {
    if (audio_play.paused) {
      audio_play.play();
      $('.my-musik').removeClass('mdi-music-off');
      $('.my-musik').addClass('mdi-music');
    } else {
      audio_play.pause();
      $('.my-musik').removeClass('mdi-music');
      $('.my-musik').addClass('mdi-music-off');
    }
  });
})(window.jQuery);
